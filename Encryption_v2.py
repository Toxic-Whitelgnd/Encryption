...
class Login(tk.Tk):
    def __init__(self, master) -> None:
        ...
        self.username_label = Label(self.fram_body, text="Username:",bg="black",fg="red")
        self.password_label = Label(self.fram_body, text="Password:",bg="black",fg="red",border=2)
        ...
        self.login_btn = Button(self.fram_body, text="Login"+str(self.a2), command=self.login_btn_com,fg="red",bg="black",activebackground="yellow",
                                font=("Arial",10),border=4,borderwidth=4)
...
class signup_window():
    def __init__(self, master) -> None:
        ...
        self.master_sign.geometry("400x440")
        ...
        # entry field
        self.usr_entry = Entry(self.frame_body, width=20,bg="#99bdff")
        self.pass_entry = Entry(self.frame_body, width=20,bg="#99bdff")
        self.email_entry = Entry(self.frame_body, width=20,bg="#99bdff")
...
class encryption():
    def __init__(self, master):
        ...
        self.label_head = ttk.Label(self.frame_header, text="ENCRYPTION!!!", font=('Showcard Gothic', 20, 'bold'),
                                    style='header.TLabel')
...
class decryption:
    def __init__(self, master):
        ...
        # creating a label and entry
        self.label_head = ttk.Label(self.frame_headers, text="DECRYPTION!!!", font=('Showcard Gothic', 23, 'bold'),
                                    style='header.TLabel')
        self.img_header = PhotoImage(
            file='img_window1/rsz_window2_back.gif').subsample(2, 2)
