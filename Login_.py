...
class Encrypt_Decrypt(Login):
    def __init__(self,master):
        ...
        self.encr_img=PhotoImage(file="C:/Users/HOME/VSCODE/Login_Vs code/img_window1/rsz_1rsz_heade_back.gif") #make the header with aa diagram
        self.imf_header=ttk.Label(self.frame_header,image=self.encr_img)
        self.imf_header.grid(row=0,column=1)
        self.back_grod = PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/rsz_wallpaperflarecom_wallpaper.gif')
        ...
        self.btn_encryp=PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/rsz_download.gif')
        self.btn_decryp = PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/rsz_download_1.gif')
        self.btn_quit = PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/rsz_qiut.gif')
...
class encryption():
    def __init__(self,master):
        ...
        self.back_grod = PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/rsz_rdblu4.gif')
        self.img_label = ttk.Label(self.frame_body, image=self.back_grod)
        self.img_label.place(x=0, y=0)
        ...
        #creasting icon\
        self.master_encryp.iconbitmap('C:/Users/HOME/VSCODE/Login_Vs code/img_window1/data-encryption-32.ico')
        ...
        self.img_header=PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/rsz_window2_back.gif').subsample(2,2)
  ...
  #      self.label_design1 = ttk.Label(self.frame_body,
   #                                  text='--------------------------------------------------------------------')
        ...
        self.generate_img = PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/generate.gif').subsample(2, 2)
        self.clear_img = PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/rsz_reset.gif').subsample(2, 2)
        self.save_img = PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/save.gif').subsample(2, 2)
        self.back_img = PhotoImage(file='C:/Users/HOME/VSCODE/Login_Vs code/img_window1/back btn.gif').subsample(2, 2)
...
class decryption:
    def __init__(self,master):
        ...
        # creasting icon\
        self.master_decry.iconbitmap('C:/Users/HOME/VSCODE/Login_Vs code/img_window1/decrypted.ico')
